...
var useBlinnPhong = true;
var useBlinnPhongLoc;
...
//    gl.cullFace(gl.BACK);
    ...
    pointsArray = myTeapot.TriangleVertices;
    normalsArray = myTeapot.Normals;
    ...
    useBlinnPhongLoc = gl.getUniformLocation( program, "useBlinnPhong" );
    ...
    gl.uniform1i(useBlinnPhongLoc, useBlinnPhong ? 1 : 0);

    document.getElementById("toggleShading").addEventListener("click", function() {
        useBlinnPhong = !useBlinnPhong;
        gl.uniform1i(useBlinnPhongLoc, useBlinnPhong ? 1 : 0);
        this.textContent = useBlinnPhong ? "Switch to Phong" : "Switch to Blinn-Phong";
    });
